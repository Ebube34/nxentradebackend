...
app.post("/sign-up", (req, res) => {
  ...
  bcrypt.hash(password, saltRounds, function (err, hash) {
    if (err) {
      ...
      padding:20px 0 48px"> 
      <a href='https://postimages.org/' target='_blank'><img style="margin:0 auto; width:100%; height:370px" src='https://i.postimg.cc/YqdSTTCQ/nxentrade-logo-sign-board.png' border='0' alt='nxentrade-logo-sign-board'/></a> 
